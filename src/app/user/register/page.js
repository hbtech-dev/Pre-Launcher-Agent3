    ...
    return (
        <PreLauncherLayout>
            ...
            <div className="flex-1 flex flex-col justify-center py-4">
                ...
                <div className="mb-6">
                    <h1 className="pl-heading mb-1.5">Create User Account</h1>
                    <p className="pl-subtext">Join early and receive priority access to pre-launch properties</p>
                </div>
                ...
                <div className="pl-glass-card">
                    ...
                    <form onSubmit={handleRegister}>
                        ...
                        <div className="pl-input-group">
                            <label className="pl-label">Mobile Number</label>
                            <input
                                type="tel"
                                className="pl-input"
                        ...
                        <button
                            ...
                            disabled={isLoading}
                        >
                            {isLoading ? "Creating Account..." : "Create Account & Enter Pre-Launcher"}
                        </button>
                    </form>
                ...
                <p className="text-center mt-6 text-sm" style={{ color: "var(--pl-text-secondary)" }}>
                    ...
                    <Link href="/user/login" className="pl-link">
                        Sign In
                    </Link>
                </p>
            </div>
